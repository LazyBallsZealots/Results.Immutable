...
public sealed class ResultAssertions<T> : ResultAssertions<T, ResultAssertions<T>>
{
    /// <summary>
    ...
    internal ResultAssertions(Result<T> subject, AssertionChain chain)
        : base(subject, chain)
    {
    }
}
    ...
    where TAssertions : ResultAssertions<TSubject, TAssertions>
{
    ...
    /// </summary>
    /// <param name="subject">The <see cref="Result{T}" /> to assert.</param>
    protected internal ResultAssertions(Result<TSubject> subject, AssertionChain chain)
        : base(subject, chain)
    {
        this.chain = chain;
    }
